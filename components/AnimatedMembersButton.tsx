    ...
    <div className='z-10 flex items-center justify-center'>
      ...
      >
        <AnimatedShinyText className='flex items-center justify-center px-3 py-0.5 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400'>
          <CalendarHeart className='mr-4 size-3 scale-x-[-.9] text-blue-300 transition-transform ease-in-out group-hover:translate-x-2 sm:size-4' />
          <span className='font-heading text-xs sm:text-sm'>Book Private</span>
